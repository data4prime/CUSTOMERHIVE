...
//Qlik Server Routes
Route::get('admin/qlik_confs/QlikServerSenseHub', $controllers_base_path . 'AdminQlikItemsController@GetRouteSenseHub')->name('QlikServerSenseHub');
Route::get('admin/qlik_confs/QlikServerSenseQMC', $controllers_base_path . 'AdminQlikItemsController@GetRouteSenseQMC')->name('QlikServerSenseQMC');
