<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->form[] = ["label"=>"User Directory","name"=>"user_directory","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		$this->form[] = ["label"=>"Qlik Login","name"=>"qlik_login","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
