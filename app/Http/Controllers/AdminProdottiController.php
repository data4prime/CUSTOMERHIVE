<?php namespace App\Http\Controllers;
	...
	class AdminProdottiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Categorie Prodotti","name"=>"categorie_prodotti"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Categorie Prodotti','name'=>'categorie_prodotti','validation'=>'required','width'=>'col-sm-9'];
