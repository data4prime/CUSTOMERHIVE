<?php namespace App\Http\Controllers;
	...
	class AdminLeadsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Anagrafica","name"=>"Anagrafica","join"=>"mg_cliente,ragione_sociale"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'Name','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Anagrafica','name'=>'Anagrafica','type'=>'number','validation'=>'required','width'=>'col-sm-9'];
