...
class Cms_settingsSeeder extends Seeder
{
    public function run()
    {
        ...
        $data = [
            ...
            // Il gruppo "Qlik Configuration" non viene piu' seminato: quelle
            // righe duplicavano la tabella qlik_confs e nessuno le leggeva.
            // Vedi la migration 2026_08_27_030000_remove_qlik_configuration_settings.
        ];
