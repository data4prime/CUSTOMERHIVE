        ...
        <table class='table table-striped table-api table-bordered'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href='javascript:void(0)' title='API {{isset($ac->nama) ? $ac->nama : ''}}'
                            style='color:#009fe3' class='link_name_api'><?=$api->nama;?></a> &nbsp;
                        <sup>
                            <a title='Delete this API' onclick="deleteApi({{$api->id}})" href="javascript:void(0)"><i
                                    class='fa fa-trash'></i></a>
                            &nbsp; <a title='Edit This API'
                                href="{{url(config('crudbooster.ADMIN_PATH').'/api_generator/edit-api').'/'.$api->id}}"><i
                                        ...
                                        <table class='table table-bordered table-hover'>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{!! ($param['required'])?"<span
                                                            class='label label-primary'>REQUIRED</span>":"<span
                                                            class='label label-default'>OPTIONAL</span>"!!}</td>
                                                </tr>
                                                @endif
                                                @endforeach
                                                @if($i == 0)
                                                <tr>
                                                    <td colspan='4' align="center"><i class='fa fa-search'></i> There is
                                                        no parameter</td>
                                                </tr>
                                                @endif
                                            </tbody>
