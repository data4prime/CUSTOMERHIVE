<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="@if($active_tab == 3)active @endif">
      <a href="@if($id){{Route('ModulsControllerGetStep3',['id'=>$id])}} @else#@endif""><i class='fa fa-table'></i> Step 3 - Table Display</a>
    </li>
    <li role="presentation" class="@if($active_tab == 4)active @endif">
      <a href="@if($id){{Route('ModulsControllerGetStep4',['id'=>$id])}} @else#@endif""><i class='fa fa-plus-square-o'></i> Step 4 - Form Display</a>
    </li>
