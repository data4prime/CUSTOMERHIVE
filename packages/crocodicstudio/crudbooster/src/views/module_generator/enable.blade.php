                                ...
                                <?php
                                 ...
                                 ?>
                                  <td class='info' align="center">
                                    <input {{$checked}} title='Check all Modules' type='checkbox' class="bulk_check_tenant" data-tenant-id="{{$tenant->id}}"/>
                                  </td>
                                <?php } ?>
                            </tr>
                            </thead>
                                ...
                                <tr>
                                    ...
                                    <td class='info' align="center">
                                      <?php
                                       ...
                                       ?>
                                      <input type='checkbox' title='Check all Tenants' {{$checked}} class='bulk_check_module' data-module-id="{{$module->id}}"/>
                                    </td>
                                    <?php
                                     ...
                                     ?>
                                      <td class='<?=$colors[$key]?>' align="center">
                                        <input {{$checked}} type='checkbox' class="module_tenant_enabler" data-tenant-id='{{$tenant->id}}' data-module-id='{{$module->id}}' name='module_tenant_enabler[<?=$module->id?>][<?=$tenant->id?>]' value='1'/>
                                      </td>
                                    <?php } ?>
                                </tr>
                            @endforeach
