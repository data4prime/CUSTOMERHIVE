...
class QlikConfController extends CBController
{
	...
	public function cbInit()
	{
        ...
        $this->form[] = ['label' => 'QRSCertfile', 'name' => 'QRSCertfile', 'type' => 'upload_file', 'validation' => 'required|string|min:1|max:255', 'width' => 'col-sm-10', 'placeholder' => 'Enter QRSCertfile'];
        $this->form[] = ['label' => 'QRSCertkeyfile', 'name' => 'QRSCertkeyfile', 'type' => 'upload_file', 'validation' => 'required|string|min:1|max:255', 'width' => 'col-sm-10', 'placeholder' => 'Enter QRSCertkeyfile'];
        ...
        $this->form[] = ['label' => 'Private Key', 'name' => 'private_key', 'type' => 'upload_file', 'validation' => 'required|string|min:1', 'width' => 'col-sm-10', 'placeholder' => 'Enter Private Key'];
