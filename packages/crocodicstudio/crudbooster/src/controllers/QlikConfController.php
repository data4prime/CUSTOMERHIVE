	...
	public function cbInit()
	{
        ...
        */
		...
		if (CRUDBooster::isSuperadmin()) {
            $this->addaction[] = ['label' => '', 'url' => Route('QlikServerSenseHub/[id]'), 'icon' => 'fa fa-desktop', 'color' => 'primary', 'title' => 'Qlik Sense Hub'];
			$this->addaction[] = ['label' => '', 'url' => Route('QlikServerSenseQMC/[id]'), 'icon' => 'fa fa-code', 'color' => 'primary', 'title' => 'Qlik Sense QMC'];
