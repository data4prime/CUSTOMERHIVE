...
class AdminGroupsController extends CBController
{
	...
	public function tenant($group_id, $alert_id = null)
	{
		...
		//add tenant form
		$data['forms'] = [];
		$data['forms'][] = ['label' => 'Name', 'name' => 'name', 'type' => 'group_tenant_datamodal', 'width' => 'col-sm-6', 'datamodal_table' => 'tenants', 'datamodal_where' => 'tenants.deleted_at=null', 'datamodal_columns' => 'name', 'datamodal_columns_alias' => 'Name', 'datamodal_select_to' => $group_id, 'required' => true];
