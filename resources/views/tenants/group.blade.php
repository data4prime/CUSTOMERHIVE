                          ...
                          <div class="col-sm-10">
                              ...
                              @if(CRUDBooster::isCreate() || CRUDBooster::isUpdate())
                                  ...
                                  @if($button_save && $command != 'detail')
                                      <input type="submit" name="submit" value='{{trans("crudbooster.button_add_member")}}' class='btn btn-success'>
                                  @endif
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a title='Remove' class='btn btn-danger btn-sm' href='{{CRUDBooster::mainpath("$tenant_id/remove_group/$group->id")}}'><i class="fa fa-trash"></i></a>
              @endif
            </td>
          </tr>
          @endforeach
